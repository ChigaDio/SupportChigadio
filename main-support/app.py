...
#ObjectPool.cs 生成
if not os.path.exists(os.path.join(DATA_DIR,SCRIPT,OBJECTPOOL,"ParticleObjectPool.cs")):
        code_str = """
using System;
...
namespace GameCore.Gameobject
{
    ...
    public struct TimedAction
    {
        ...
        """
        with open(os.path.join(DATA_DIR,SCRIPT,OBJECTPOOL,"ParticleObjectPool.cs"),"w",encoding="utf-8") as f:
            f.write(code_str)

if not os.path.exists(os.path.join(DATA_DIR,SCRIPT,OBJECTPOOL,"SoundObjectPool.cs")):
        code_str = """
//===================================================================
// SoundObjectPool.cs 
//==================================================================
...
"""
        with open(os.path.join(DATA_DIR,SCRIPT,OBJECTPOOL,"SoundObjectPool.cs"),"w",encoding="utf-8") as f:
            f.write(code_str)
