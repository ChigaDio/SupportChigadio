...
def init(data_dir):
    """app.py から呼び出す初期化関数。"""
    global DATA_DIR, EXPANSION_DIR, RADAR_CHART_GENERATOR_DIR, RADAR_CHART_GENERATOR_EDITOR_DIR
    global RADAR_CHART_GENERATOR_RADERCHART_CS, RADAR_CHART_GENERATOR_RADARCHARTCONTROLLER_CS, RADAR_CHART_GENERATOR_RADERCHARTGENERATORWINDOW_CS
